...
st.write('Most objects') # df, err, func, keras!  #안에 변수를 넣어도 알아서 처리해준다.
st.write(['st', 'is <', 3]) # see *  #리스트를 넣으면 0번방에 st 1번방에 is < 이렇게 뜬ㄴ다.
st.title('My title')
st.header('My header')  #제목
st.subheader('My sub')   #소제목
